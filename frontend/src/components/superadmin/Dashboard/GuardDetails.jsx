...
const GuardDetails = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('https://hostel-sync-1.onrender.com/super-admin/guards', {
    ...
    const handleDelete = async (guardId) => {
        try {
            ...
            const response = await axios.delete(`https://hostel-sync-1.onrender.com/gateSecurity/delete/${guardId}`, {
