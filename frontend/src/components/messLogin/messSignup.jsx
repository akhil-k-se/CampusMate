    ...
    const handleSignUp = async (e) => {
        ...
        try {
            const response = await axios.post(
                "https://campus-mate.onrender.com/mess/signup",
                formData, {
            ...
            <div class="logContainer active flex items-center justify-center relative" id="logContainer">
                ...
                <div className='w-[400px]'>
                    <form onSubmit={handleSignUp}>
                        ...
                        <div className='relative w-[100%]'>
                            <input type={confirmPasswordVisible ? "text" : "password"} name="confirmPassword" id='confirmPassword' onChange={handleChange} value={formData.confirmPassword} placeholder="Confirm Password" />
                            <FontAwesomeIcon
