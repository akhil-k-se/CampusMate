  ...
  return (
    <div className={`fixed top-0 bottom-0 ${isShrunk ? "w-[80px]" : "w-[300px]"} bg-gray-900 p-2 transition-all duration-300`}>
      ...
      <div className="text-center text-gray-100 mt-20">
        ...
        <Link to="/hostelrooms" className='p-2.5 flex items-center rounded-md px-4 mt-3 duration-300 cursor-pointer group hover:bg-gray-600'>
          <i className='bi bi-buildings-fill text-xl px-3 py-2 rounded-md bg-[#e82574]'></i>
          <span className={`text-[17px] ml-4 text-gray-300 font-bold group-hover:text-white ${isShrunk ? "hidden" : "block"}`}>Hostel Rooms</span>
        </Link>
