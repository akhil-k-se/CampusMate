  ...
  return (
    <>
      ...
      <div
        ...
        } bg-[#383433] flex justify-center items-center h-[93.3vh]`}
      >
        <div className="w-full max-w-lg bg-white shadow-lg rounded-lg border border-gray-300 overflow-hidden">
          <div className="flex items-center justify-between p-4 bg-[#a48152]">
            <img
          ...
          <div className="p-3">
            <div className="mb-1 flex items-center">
              ...
              {isEditing && (
                <FontAwesomeIcon
                  icon={faPencilAlt}
                  className="w-5 h-5 text-[#a48152] ml-2 cursor-pointer"
                />
              )}
            </div>
            <div className="mb-1 flex items-center">
          ...
          <div className="bg-gray-100 px-3 py-2 text-right">
            {/* <button
              ...
              className="bg-[#a48152] text-white px-3 py-1 rounded-md shadow-md hover:bg-[#a48152] transition"
            >
